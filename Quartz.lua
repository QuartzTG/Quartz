...
print('\n\27[1;34m Welcome to the all-new and powerful Source Quartz ')
file = io.open("Quartz", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Quartz
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Quartz.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Quartz -X kill
screen -S Quartz ./Quartz
done
]])  
file:close() 
...
--------------------------------------------------------------------------------------------------------------
print([[
  _____ _   _ _____ ___   _____ _______ 
  (  _  ) ) ( )  _  )  _ \(_   _)_____  )
  | ( ) | | | | (_) | (_) ) | |      / / 
  | | | | | | |  _  )    /  | |    / /   
  | (( \| (_) | | | | |\ \  | |  / / ___ 
  (___\_)_____)_) (_)_) (_) (_) (_______)
...
if hash or SudoBot(msg) or DevQuartzW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevQuartzW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevQuartzW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevQuartzW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevQuartzW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevQuartzW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevQuartzW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1699369976) then
var = true  
...
local UserName = (data.username_ or "KKKKiK")
...
local Quartz_Msg = ''  
if msgs < 100 then 
Quartz_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Quartz_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Quartz_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Quartz_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Quartz_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Quartz_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Quartz_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Quartz_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Quartz_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Quartz_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Quartz_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Quartz_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Quartz_Msg = 'رب التفاعل'  
end 
return Quartz_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceQuartz(msg,data) -- بداية العمل
if msg then
...
SourceQuartzr = '𝆥 ༯ اهلا عزيزي\n 𝆥 ༯ انا بوت اسمي '..Namebot..'\n 𝆥 ༯ اختصاصي حمايه الكروبات\n 𝆥 ༯ من تكرار والسبام والتوجيه والخ…\n 𝆥 ༯ لتفعيلي اتبع الاخطوات…↓\n 𝆥 ༯ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ 𝆥 ༯ [قناة سورس البوت](http://t.me/KKKKiK)'
end 
send(msg.chat_id_, msg.id_, SourceQuartzr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevQuartzW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevQuartzW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,Quartz_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevQuartzW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevQuartzW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevQuartzW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevQuartzW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevQuartzW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𝆥 ༯ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevQuartzW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𝆥 ༯ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevQuartzW(msg) then 
...
if text == 'تحديث المتجر ❃' and DevQuartzW(msg) then 
  ...
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/QuartzTG/Files/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/QuartzTG/Files/master/File_Bot/rd.lua") 
  send(msg.chat_id_, msg.id_,' 𝆥 ༯ تم تحديث \n 𝆥 ༯ لديك اخر اصدار للمتجر')
  dofile('Quartz.lua')  
  end
if text == 'رقم البناء ❃' and DevQuartzW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𝆥 ༯ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{66w4q}')
end
if text == 'الاصدار ❃' and DevQuartzW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' 𝆥 ༯ اصدار سورس كوارتز\n 𝆥 ༯ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevQuartzW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' 𝆥 ༯ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور - @iKKKKK ')
    end
if text == 'قناه تحديثات البوت ❃' and DevQuartzW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𝆥 ༯ [تحديثات البوت](t.me/KKKKiK) \n 𝆥 ༯ [قناه السورس](t.me/KKKKiK)')
end
if text == "ضع اسم للبوت ❃" and DevQuartzW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevQuartzW(msg) then 
...
if text == 'المشتركين ❃' and DevQuartzW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𝆥 ༯ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevQuartzW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𝆥 ༯ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevQuartzW(msg) then
...
if text == ("قائمه العام ❃") and DevQuartzW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevQuartzW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevQuartzW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل الان اذاعتك؟ \n 𝆥 ༯ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevQuartzW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل الان اذاعتك؟ \n 𝆥 ༯ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevQuartzW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل الان اذاعتك؟ \n 𝆥 ༯ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevQuartzW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevQuartzW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevQuartzW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevQuartzW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevQuartzW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'𝆥 ༯  عدد الكروبات الان » { '..#group..' }'..Quartzk..''..Quartz..'\n𝆥 ༯  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevQuartzW(msg) then
...
usertext = '\n 𝆥 ༯ العضو » ['..result.title_..'](t.me/'..(username or 'KKKKiK')..')'
status  = '\n 𝆥 ༯ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevQuartzW(msg) then
...
usertext = '\n 𝆥 ༯ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKKiK')..')'
status  = '\n 𝆥 ༯ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevQuartzW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevQuartzW(msg) then
...
local Quartz1_Msg = database:get(bot_id.."Quartz1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Quartz1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𝆥 ༯ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKKiK')..') \n 𝆥 ༯ '..Quartz1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Quartz_Msg and not Special(msg) then  
local Quartz_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Quartz_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 𝆥 ༯ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𝆥 ༯ ["..Quartz_Msg.."] \n")
else
send(msg.chat_id_,0," 𝆥 ༯ العضو : {["..data.first_name_.."](T.ME/KKKKiK)}\n 𝆥 ༯ ["..Quartz_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𝆥 ༯ عذرا » {["..data.first_name_.."](T.ME/KKKKiK)}\n 𝆥 ༯ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevQuartzW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevQuartzW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevQuartzW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𝆥 ༯ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevQuartzW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𝆥 ༯ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevQuartzW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𝆥 ༯ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevQuartzW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𝆥 ༯ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevQuartzW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevQuartzW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𝆥 ༯ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevQuartzW(msg) then  
...
database:sadd(bot_id.."Quartz:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Quartz:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Quartz = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Quartz then 
names_Quartz = database:smembers(bot_id.."Quartz:blocname"..msg.chat_id_) or ""
if names_Quartz and names_Quartz[1] then 
for i=1,#names_Quartz do 
if name_Quartz:match("(.*)("..names_Quartz[i]..")(.*)") then 
...
database:set(bot_id.."Quartz:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Quartz:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Quartz:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Quartz:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Quartz:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Quartza_new(Quartz1,Quartz2)
if Quartz2 and Quartz2.first_name_ then 
if Quartz2.first_name_:match("(.*)"..database:get(bot_id.."Quartz:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Quartz:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Quartz_nnn = database:get(bot_id.."Quartz:nump"..msg.chat_id_) or 5
local Quartz_nnn2 = database:get(bot_id.."Quartz:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Quartz_nnn2) == tonumber(Quartz_nnn) or tonumber(Quartz_nnn2) > tonumber(Quartz_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Quartz:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "𝆥 ༯ عزيزي >>["..Quartz2.username_.."](https://t.me/"..(Quartz2.username_ or "KKKKiK")..")\n𝆥 ༯ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Quartz:teh"..msg.chat_id_).."} بجانب اسمك\n𝆥 ༯ عدد المحاولات المتبقيه {"..(tonumber(Quartz_nnn) - tonumber(Quartz_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Quartza_new)
end
end
...
local QuartzChengName = database:get(bot_id.."Quartz:Cheng:Name"..data.id_)
if not data.first_name_ then 
if QuartzChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..QuartzChengName..']')
database:del(bot_id.."Quartz:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if QuartzChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Quartz:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local QuartzChengUserName = database:get(bot_id.."Quartz:Cheng:UserName"..data.id_)
if not data.username_ then 
if QuartzChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..QuartzChengUserName..']')
database:del(bot_id.."Quartz:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if QuartzChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Quartz:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local QuartzChengPhoto = database:get(bot_id.."Quartz:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if QuartzChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Quartz:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if QuartzChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Quartz:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
 ...
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ...
  ↬ . [DEVELOPER](t.me/iKKKKK)       
   
  ↬ . [Information](t.me/KKKKiK) 
...
if text == 'رفع نسخه الاحتياطيه' and DevQuartzW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف الاوامر المضافه' or text == 'مسح الاوامر المضافه' or text == 'مسح الاوامر' then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𝆥 ༯ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKKiK')..') \n 𝆥 ༯ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𝆥 ༯ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KKKKiK')..') \n 𝆥 ༯ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevQuartzW(msg) then    
dofile('Quartz.lua')  
send(msg.chat_id_, msg.id_, ' 𝆥 ༯ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevQuartzW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevQuartzW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevQuartzW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevQuartzW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevQuartzW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevQuartzW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevQuartzW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevQuartzW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevQuartzW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevQuartzW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevQuartzW(msg) then
...
if text == 'الملفات' and DevQuartzW(msg) then
t = ' 𝆥 ༯ ملفات السورس كوارتز↓\n≪━━━━━━QR━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevQuartzW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/QuartzTG/Files/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𝆥 ༯ اهلا بك في متجر ملفات كوارتز\n 𝆥 ༯ ملفات السورس ↓\n≪━━━━━━QR━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━QR━━━━━━≫\n 𝆥 ༯ علامة تعني { ✓ } ملف مفعل\n 𝆥 ༯ علامة تعني { ✘ } ملف معطل\n 𝆥 ༯ قناة سورس كوارتز↓\n".." 𝆥 ༯ [اضغط هنا لدخول](t.me/KKKKiK) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevQuartzW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/QuartzTG/Files/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Quartz.lua')  
else
send(msg.chat_id_, msg.id_," 𝆥 ༯ عذرا الملف لايدعم سورس كوارتز\n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevQuartzW(msg) then
...
if text == "مسح الملفات" and DevQuartzW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," 𝆥 ༯ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevQuartzW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevQuartzW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "KKKKiK")
...
function Function_Quartz(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Quartz, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Quartz, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𝆥 ༯ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKKiK')..')'
status  = '\n 𝆥 ༯ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𝆥 ༯ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𝆥 ༯ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKKiK')..')'
...
database:set(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Quartz1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Quartz1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𝆥 ༯ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Quartz1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Quartz1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Quartz1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 𝆥 ༯ ارسل الكلمه الان")  
database:set(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Quartz1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Quartz1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Quartz1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Quartz1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Quartz1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Quartz1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n 𝆥 ༯ قائمة المنع \n≪━━━━━━QR━━━━━━≫\n"
for k,v in pairs(list) do  
local Quartz_Msg = database:get(bot_id.."Quartz1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Quartz_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevQuartzW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' 𝆥 ༯ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevQuartzW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𝆥 ༯ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'KKKKiK')..')'..'\n 𝆥 ༯ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevQuartzW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevQuartzW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Quartz_Msg[math.random(#Quartz_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevQuartzW(msg) then 
...
if text == ("مسح ردود المطور") and DevQuartzW(msg) then 
...
if text == ("ردود المطور") and DevQuartzW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𝆥 ༯ قائمة ردود المطور \n≪━━━━━━QR━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevQuartzW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevQuartzW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevQuartzW(msg) then   
...
if text == 'تعطيل المغادره' and DevQuartzW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𝆥 ༯ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Quartz')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKKiK')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Quartzdx(msg.chat_id_, msg.id_, ' 𝆥 ༯ ايدي المجموعة » ( '..msg.chat_id_..' )\n 𝆥 ༯ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n 𝆥 ༯ عدد المحظورين » ( *'..data.kicked_count_..' )*\n 𝆥 ༯ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevQuartzW(msg) then
...
return false
  ...
  {
    {text = '-𝙌𝙪𝙖𝙧𝙩𝙯 𝙏𝙚𝙖𝙢', url="t.me/KKKKiK"},
  },
}
...
zh = https.request('https://rudi-dev.tk/Amir1/Quartz.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n𝆥 ༯ قائمه الزخرفه \nٴ𝆥 ༯ٴ≪━━━━━━QR━━━━━━≫ٴ𝆥 ༯○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ𝆥 ༯ٴ≪━━━━━━QR━━━━━━≫ٴ𝆥 ༯○ٴ\n𝆥 ༯ 彡 .[Quartz 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/KKKKiK)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/Quartz.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/Quartz.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
Quartz = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Quartz)
...
--------------------------------------------------------------------------------------------------------------
SourceQuartz(data.message_,data)
...
------------------------------------------------------------------------
local QuartzAbot = database:get(bot_id.."Quartz1:Add:Filter:Rp2"..text..result.chat_id_)   
if QuartzAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 𝆥 ༯ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𝆥 ༯ ["..QuartzAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Quartz1_Msg = database:get(bot_id.."Quartz1:Add:Filter:Rp2"..text..result.chat_id_)   
if Quartz1_Msg then    
send(msg.chat_id_, msg.id_," 𝆥 ༯ "..Quartz1_Msg)
