...
if DevQuartzW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/QuartzTEAM/Files_Quartz/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/QuartzTEAM/Files_Quartz/master/File_Bot/"..file)
if res == 200 then
...
return false
  ...
  {
  {text = '𝐁𝐎𝐘𝐊𝐀 {𝐑} 𝐓𝐄𝐀𝐌', url="t.me/KKKKiK"},
  },
  }
...
if text == "غنيلي" and Manager(msg) then 
  data,res = https.request('https://Quartz-api.ml/audios.php')
if res == 200 then
